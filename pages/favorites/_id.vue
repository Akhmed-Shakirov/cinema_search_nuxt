<template>
  <div class="container"><br>
    <div class="movie-list">
      ...
      <div class="rows">
        <b-btn variant="danger" @click="removeTodo(movie, 'danger')">Delete in favorites</b-btn>
      </div> 
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    removeTodo (movie, variant = null){
      this.$store.commit('favorites/remove', movie)
      this.$bvToast.toast('This is movie delete in favorites', {
        title: `${movie.title}`,
        variant: variant,
        autoHideDelay: 2000,
        solid: true
